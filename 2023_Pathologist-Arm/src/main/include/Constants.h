...
namespace ArmConstants {
    ...
    const double kBottomGoingUpP = 0; // change this
    const double kBottomGoingUpD = 000.0; // change this
     const double kBottomGoingUpF = 1; // change this

    const double kBottomGoingDownP = 0; // change this
    const double kBottomGoingDownD = 000.0; // change this
    const double kBottomGoingDownF = 1; // change this
    ...
    const double DegreesToEncoder = 0.4423; // change this
