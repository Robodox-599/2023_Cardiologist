...
//  m_BottomSolenoid{frc::PneumaticsModuleType::CTREPCM, IntakeConstants::IntakePistonRA, IntakeConstants::IntakePistonRB}
{
    ...
    m_BottomFollowerPID.SetP(ArmConstants::kBottomGoingUpP, 0);
    m_BottomFollowerPID.SetD(ArmConstants::kBottomGoingUpD, 0);
    // m_BottomFollowerPID.SetFF(ArmConstants::kBottomGoingUpF, 0);
    m_TopFollowerPID.SetP(ArmConstants::kTopGoingUpP, 0);
    m_TopFollowerPID.SetD(ArmConstants::kTopGoingUpD, 0);
...
{
    m_DesiredPos = -14.0;
    m_BottomArmPID.SetReference(-1.5 * 60, rev::ControlType::kVelocity);
