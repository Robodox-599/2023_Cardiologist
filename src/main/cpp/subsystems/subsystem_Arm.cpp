                                 ...
                                 m_WristFeedforward{ArmConstants::kWristS, ArmConstants::kWristG, ArmConstants::kWristV, ArmConstants::kWristA}
{
    ...
    m_ShoulderRelEncoder.SetPosition(0);
     ...
     //(m_ElbowAbsEncoder.GetAbsolutePosition() - 0.77) * ArmConstants::kElbowGearRatio
...
frc2::CommandPtr subsystem_Arm::ToHighConeCommand(){
    ...
    frc2::cmd::Deadline(frc2::WaitUntilCommand([this]{return ShoulderThreshold(ArmConstants::HighConeShoulder * 0.80);}).ToPtr(),
...
frc2::CommandPtr subsystem_Arm::ToHighCubeCommand(){
    return frc2::cmd::Sequence(
    ...
    MoveShoulderCommand(ArmConstants::HighCubeShoulder)
    );
}

// frc2::CommandPtr subsystem_Arm::ToMidCubeCommand(){
//     return frc2::cmd::Sequence(
//     frc2::cmd::Deadline(frc2::WaitUntilCommand([this]{return ElbowThreshold(ArmConstants::HighCubeElbow * 0.80);}).ToPtr(),
//                     MoveElbowCommand(ArmConstants::HighCubeElbow)),      )
// }
...
void subsystem_Arm::SetElbowPIDByDirection(double Elbow)
{
    ...
    {
        m_ElbowMotor.SetSmartCurrentLimit(13);
        m_ElbowSlot = 0;
    }
    else
    {
...
void subsystem_Arm::Periodic()
{
    switch(m_ArmPoll){
        case DPAD::NODE_LEVEL::HIGH:
            frc::SmartDashboard::PutString("Node Level", "HIGH");
            break;
        case DPAD::NODE_LEVEL::MID:
            frc::SmartDashboard::PutString("Node Level", "MID");
            break;
        case DPAD::NODE_LEVEL::LOW:
            frc::SmartDashboard::PutString("Node Level", "LOW");
            break;
        case DPAD::NODE_LEVEL::NON_SPECIFIED:
            frc::SmartDashboard::PutString("Node Level", "NON_SPECIFIED");
            break;    
    }
    frc::SmartDashboard::PutNumber("ArmPollSubyStem", m_ArmPoll);
...
// :)
    ...
    ShoulderFF = m_ShoulderFeedforward.Calculate((DesiredShoulderRadians + units::radian_t{1.24965}), ArmConstants::kEndVel, units::angular_acceleration::degrees_per_second_squared_t{1});
