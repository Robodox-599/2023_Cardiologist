...
frc2::CommandPtr subsystem_Intake::ClampCommand(){
    return RunOnce([this]{return IntakeClose();});
}

frc2::CommandPtr subsystem_Intake::UnclampCommand(){
    return RunOnce([this]{return IntakeOpen();});
}

frc2::CommandPtr subsystem_Intake::ToggleCommand(){
    return RunOnce([this]{return IsIntakeOpen() ? IntakeClose() : IntakeOpen();});
}
