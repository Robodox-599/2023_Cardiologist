...
frc2::CommandPtr ArmMovements::ToDoubleSubstation(subsystem_Arm *Arm){//could change use constants file to find a better threshold
  return frc2::cmd::Parallel(command_MoveElbow(Arm, [=]{return ArmConstants::DoubleSubstationElbow;}, [=]{return true;}, [=]{return ArmConstants::DoubleSubstationElbow;}).ToPtr(),
...
//change above parallel to sequence if not work
//notes ^ by Salik, Ken, Hannah, Brennon
