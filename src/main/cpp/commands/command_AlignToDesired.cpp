...
command_AlignToDesired::command_AlignToDesired(subsystem_DriveTrain* DriveTrain, std::function<double()> XDesired, std::function<double()> YDesired, std::function<double()> ThetaDesired): m_DriveTrain{DriveTrain}, m_X{XDesired}, m_Y{YDesired}, m_Theta{ThetaDesired}{
