...
private:
  ...
  // std::vector<std::pair<photonlib::PhotonCamera, frc::Transform3d>> cameras {std::make_pair(photonlib::PhotonCamera{"Global_Shutter_Camera"}, 
  //                                                   frc::Transform3d{ frc::Translation3d(16.75_in, -7_in, 14.5_in), frc::Rotation3d(0_rad, 0_rad, 0_rad)}) };
  
  // photonlib::RobotPoseEstimator m_PoseEstimator{frc::LoadAprilTagLayoutField(frc::AprilTagField::k2023ChargedUp), 
  ...
  frc::AprilTagFieldLayout m_Field {frc::LoadAprilTagLayoutField(frc::AprilTagField::k2023ChargedUp)};
  photonlib::PhotonPipelineResult m_Screenshot{};
  photonlib::PhotonTrackedTarget m_Target{};
