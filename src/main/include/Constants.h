...
namespace IntakeConstants {
    ...
    constexpr units::meter_t DistanceToMidCubeY{30.45_in};
    constexpr units::meter_t DistanceToHighCubeY{13.76_in};

    constexpr units::meter_t InitialHeight{};
    constexpr units::degree_t AngleOfLaunch{};
    constexpr units::meter_t DistanceToHighCubeZ{};
    constexpr units::meter_t DistanceToMidCubeZ{};
    constexpr units::second_t CubeFlightTime{};
