...
class RobotContainer {
 ...
 private:
  ...
  frc2::CommandPtr m_One_Cone_Taxi = autos::One_Cone_Taxi(&m_Drive, &m_PoseTracker, &m_Intake, &m_Arm);
  frc2::CommandPtr m_Two_Cone_Taxi_Balance = autos::Two_Cone_Taxi_Balance(&m_Drive, &m_PoseTracker, &m_Intake, &m_Arm);
  frc2::CommandPtr m_Three_Cone_Taxi = autos::Three_Cone_Taxi(&m_Drive, &m_PoseTracker, &m_Intake, &m_Arm);
