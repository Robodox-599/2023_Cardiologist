...
class RobotContainer {
 ...
 private:
  ...
  frc2::CommandPtr m_TaxiAuto = autos::Kasparov(&m_Drive);
  frc2::CommandPtr m_OneScoreAndTaxi = autos::OneScoreAndTaxi(&m_Drive, &m_Intake, &m_Arm);
  frc2::CommandPtr m_TwoScoreAndTaxi = autos::TwoScoreAndTaxi(&m_Drive, &m_Intake, &m_Arm);
  frc2::CommandPtr m_ThreeScoreAndTaxi = autos::ThreeScoreAndTaxi(&m_Drive, &m_Intake, &m_Arm);

  frc2::CommandPtr m_TwoTaxiAndBalance = autos::TwoTaxiAndBalance(&m_Drive);
